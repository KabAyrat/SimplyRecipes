    ...
    <main class="page">
      <div class="recipe-page">
        <section class="recipe-hero">
          <img
            src="./assets/recipes/kistibiy.jpg"
            class="img recipe-hero-img"
          />
          <article class="recipe-info">
            <h2>Кыстыбый</h2>
            <p>
              Кыстыбый – традиционное татарское блюдо, которое представляет собой обжаренную постную лепешку с начинкой. Это вкусное угощение можно купить в национальных кафе и закусочных. Или воспользуйтесь подобранными нами 10 рецептами вкусного кыстыбыя и приготовьте его самостоятельно.
            </p>
            ...
            <p class="recipe-tags">
              Приготовлено с помощью :<a href="tat-template.html">Татарская кухня</a>
        ...
        <section class="recipe-content">
          ...
          <article class="second-column">
            ...
            <div>
              ...
              <p class="single-tool">Противень</p>
            </div>
          </article>
        </section>
      </div>
