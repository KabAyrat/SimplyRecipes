...
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <!-- <meta http-equiv="X-UA-Compatible" content="IE=edge" /> --> <!--для праивльного отображения в IE-->
      ...
      <section class="recipes-container">
        ...
        <div class="tags-container">
          ...
          <?php foreach($info2 as $category): ?>
            <a href="meat-template.html"><?= $category['category']?></a>
            <?php endforeach; ?>
          </div>
        </div>
        <!-- конец сортировки -->
