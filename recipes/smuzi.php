...
if ($query = $db -> query("SELECT * FROM recipes WHERE id = 3")){
    ...
    if ($query2 = $db->query("SELECT * FROM category WHERE id = 2")) {
        ...
        <section class="recipe-content">
          <article>
            ...
            <div class="single-instruction">
              ...
              Взбейте компоненты несколько минут, до получения однородного фруктового пюре. Добавьте молоко и взбейте все еще 1-2 минуты на высокой скорости.              </p>
            </div>
            <!-- конец этапа -->
            <!--  новый этап -->
            <div class="single-instruction">
              ...
              <p>
              Разлейте напиток по бокалам, украсьте по настроению и подавайте к столу.              </p>
            </div>
            <!-- конец этапа -->
          ...
          <article class="second-column">
            <div>
              <h4>ингредиенты</h4>
              <p class="single-ingredient">Бананы</p>
              <p class="single-ingredient">Клубника</p>
              <p class="single-ingredient">Мёд</p>
              <p class="single-ingredient">Молоко</p>
            </div>
            <div>
              <h4>Инструменты</h4>
              <p class="single-tool">миксер</p>
              <p class="single-tool">стаканы</p>
            </div>
          </article>
        </section>
      </div>
